module Facility
   class V1 < Grape::API
      ...
      params do
         requires :namespace_id, type: Integer, desc: 'namespace identifier'
      ...
      get :facilities do
         ...
         case @type
         when :api
            not_found! 'Namespace' unless ns = DB::Namespace.find_by(id: params[:namespace_id])
         when :access
            not_found! 'Namespace' unless ns = DB::User.find_by(uid: @token['user']).namespaces.find_by(id: params[:namespace_id])
         end
      ...
      params do
         requires :facility_id, type: Integer, desc: 'facility identifier'
      ...
      get :rents do
         ...
         find_token
         not_found! 'Facility' unless facility = DB::Facility.find_by(id: params[:facility_id])
